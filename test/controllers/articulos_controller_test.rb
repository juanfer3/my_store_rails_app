...
class ArticulosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create articulo" do
    assert_difference('Articulo.count') do
      post articulos_url, params: { articulo: { cantidad: @articulo.cantidad, categoria_id: @articulo.categoria_id, descripcion: @articulo.descripcion, nombre: @articulo.nombre, nuevo: @articulo.nuevo, precio: @articulo.precio } }
    end
  ...
  test "should update articulo" do
    patch articulo_url(@articulo), params: { articulo: { cantidad: @articulo.cantidad, categoria_id: @articulo.categoria_id, descripcion: @articulo.descripcion, nombre: @articulo.nombre, nuevo: @articulo.nuevo, precio: @articulo.precio } }
